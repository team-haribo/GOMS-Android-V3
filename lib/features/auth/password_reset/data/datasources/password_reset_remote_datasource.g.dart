...
part of 'password_reset_remote_datasource.dart';
...
class _PasswordResetRemoteDataSource implements PasswordResetRemoteDataSource {
  _PasswordResetRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
