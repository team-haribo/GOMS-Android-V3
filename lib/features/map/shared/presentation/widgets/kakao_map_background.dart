...
class _KakaoMapBackgroundState extends State<KakaoMapBackground> {
  ...
  static const _defaultZoomLevel = 17; // 기본 카메라 줌 레벨
  static const _selectedPlaceZoomLevel = 18; // 장소 선택시 카메라 줌 레벨
  static const _instantCameraAnimation = kakao.CameraAnimation(0); // 즉시 카메라 애니메이션
