...
final kakaoMapBackgroundErrorProvider = NotifierProvider.autoDispose
    .family<_KakaoMapBackgroundErrorNotifier, String?, String>(
  _KakaoMapBackgroundErrorNotifier.new,
);

final kakaoMapBackgroundControllerProvider = NotifierProvider.autoDispose
    .family<_KakaoMapBackgroundControllerNotifier, kakao.KakaoMapController?,
        String>(_KakaoMapBackgroundControllerNotifier.new);
