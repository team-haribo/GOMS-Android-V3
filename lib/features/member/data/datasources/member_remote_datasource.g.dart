...
part of 'member_remote_datasource.dart';
...
class _MemberRemoteDataSource implements MemberRemoteDataSource {
  _MemberRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<MemberDto>> getMembers() async {
    ...
    final _options = _setStreamType<List<MemberDto>>(
    ...
    late List<MemberDto> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => MemberDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<void> updateStudentCouncilRole(
    ...
    final _options = _setStreamType<void>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v3/student-council/role/${memberId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<void> updateStudentCouncilOutingAllowed(
    ...
    final _options = _setStreamType<void>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v3/student-council/outing-allowed/${memberId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<void> withdrawMember(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
