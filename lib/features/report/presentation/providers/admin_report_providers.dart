...
final pendingReportsProvider = AsyncNotifierProvider<PendingReportsNotifier,
    List<ReportSummaryEntity>>(PendingReportsNotifier.new);

final resolvedReportsProvider = AsyncNotifierProvider<ResolvedReportsNotifier,
    List<ReportSummaryEntity>>(ResolvedReportsNotifier.new);
